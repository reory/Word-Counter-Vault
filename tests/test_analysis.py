...
def test_get_word_frequencies_basic():
    """Verify basic word-frequency counting works on simple input."""
...
def test_get_word_frequencies_punctuation():
    """Ensure word‑frequency parsing correctly ignores or strips punctuation."""
...
def test_get_word_frequencies_limit():
    """Verify word‑frequency results respect the specified maximum item limit."""
